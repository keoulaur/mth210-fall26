...
},
{
  ...
  "number": "",
  "title": "",
  "body": "Communicating in Mathematics (MATH 210, sections 02 and 03) Name: Office location: Email: Phone: "
},
{
  ...
  "number": "",
  "title": "",
  "body": " solving problems, convincing other people that you're right, and deciding whether other people are right. "
},
{
  "id": "subsec-SOR-2",
  "level": "2",
...
},
{
  ...
  "body": " A Typical Week           Monday\/Tuesday Preview Activity (due at start of class)       Prime your brain for the first class of the week. Some reading and answering questions.       Submit: Via Blackboard. I will check for questions Monday morning.    Spend: ~30-60 minutes.       Monday\/Tuesday Learning Target Quiz (in class)       Will assess your progress on learning targets. Will be done at the end of class. Study before class :)       Submit: In class. (Study before!)    Spend: ~30 minutes studying.       Wednesday\/Thursday Preview Activity (due at start of class)       Prime your brain for Wednesday's class. Some reading and answering questions.       Submit: Via Blackboard. I will check for questions Monday morning.    Spend: ~30-60 minutes.       Wednesday Weekly Practice (due at start of class)       Will help you test yourself on the week's content. These will be presented by classmates and you have the opportunity to correct your work in a different color pen.       Submit: Via Blackboard. I will check for questions Monday morning.    Spend: ~1.5 hours over the week. Material based on the previous Monday\/Wednesday.       Friday Proof Portfolio Drafts and Reflection (by 5PM)       Will help you practice your writing. This is the SWS part of the course. You'll draft and revise and learn to professionally communicate mathematics. You automatically get a 48 hour grace period on these (so turn in by Sunday at 5PM), but note that I don't check email after 5PM or on weekends.       Submit: Via Blackboard.    Spend: ~3-4 hours over the week.     "
},
{
...
},
{
  ...
  "body": " What's allowed on each type of assignment.     Assignment    Allowed    Not Allowed      Preview Activities    Collaboration with classmates, use of our textbook and notes.    Copying any answer from a resource besides our textbook, turning in things you don't understand.      Weekly Practice    Collaboration with classmates, textbook, notes.    Collaboration with students outside of our class, math center, any other resources (like anything on the internet or AI).      Proof Portfolio    Collaboration with classmates ON FIRST DRAFT with nothing written down, collaboration with Dr. Keough, notes, textbook, anything posted on Blackboard. Also see the golden rule!    Collaboration with any other student or person outside our class. Collaboration with other students on written revision. Any resources besides our textbook, Blackboard (and things posted there) and your notes (like anything on the internet or AI).      Learning Target Quizzes    Your own brain!    Collaboration with classmates, any resources.      Review Assessements    Your own brain!    Copying from any resource, turning in anything you don't understand, collaboration with classmates.     "
},
{
  ...
  "number": "1.5",
  "title": "",
  "body": " You aren't sure how to start, so you paste the problem into ChatGPT to see if you can get a hint. This is academic dishonesty. It's too easy and tempting to ask for more and more hints. And you can't write up your own solution once you've seen a solution. Instead, please ask DocK when you need a hint. She can likely give you a better one, and knows based on your work already whether you need a little nudge, or a review of some larger topic.  "
},
{
  ...
  "number": "1.6",
  "title": "",
  "body": " You've written a proof, but you want it to sound nicer. So you put your proof into a generative AI and ask it to edit it. This is also academic dishonesty. Though this may be more like how you use AI in the future, at this stage, leave getting feedback to other human writers. DocK is happy to sit with you and help your writing sound better, and still like you!  "
},
{
  ...
  "number": "1.7",
  "title": "",
  "body": " You have not made any individual progress on a problem. You ask several students, “How did you do portfolio problem 4?” until you find someone who has completed the problem and is willing to describe a route to the solution. This is academic dishonesty: the work is not your own.  "
},
{
  ...
  "number": "1.8",
  "title": "",
  "body": " You have not made any individual progress on a problem. Together with peers who also have not started the problem, you attempt to work out a route to the solution on a whiteboard. You don't take any notes, or a picture of the whiteboard. You write up your solution on your own later, away from the whiteboard. This is fine - as long as you respect the Golden Rule when writing your solution.  "
},
{
...
},
{
  ...
  "type": "Handout",
  "number": "2.1",
  "title": "Learning Targets and Quizzes",
  "body": " Learning Targets and Quizzes    Goals  There are a number of basic skills that you should demonstrate fluency with in an introduction to proofs course. These checkpoints are intended to emphasize a few things. One is that learning is a process. You will not be penalized for not demonstrating fluency with a skill the first time, but you are expected to eventually get there. Another is that fluency with basic skills and knowing definitions is an important part of doing mathematics. For example, you shouldn't expect to be able to complete a complex proof about the notion of divides if you don't know the definition of divides. These checkpoints also provide individual assessment so you know whether or not you are keeping up with course material.    Structure  We will have a closed book\/closed note checkpoint at the end of the first class meeting of the week assessing the following learning targets. While each target will be graded as only either S for Satisfactory or NY for does Not Yet meet the standard. Each target appears on 3 consecutive checkpoints. Once you have earned an S on a target you do not need to do so again. Blackboard will be updated weekly to reflect your S s and NY s. You will be notified which targets will be on a checkpoint, but it is your responsibility to know which targets you have yet to earn satisfactory. Each target will be on three checkpoints. Your grade for this component will be the percentage of the 20 targets listed below that you have earned an S on.      Learning Targets     Come to office hours to ask a question or attend a math event. (See the math major newsletter for events - .)    State precisely the definition of an even and odd integer and outline the proof of a statement using these terms.    Given a statement to be proven using a direct proof, identify the assumptions to be made and the statements to be proven.    Identify if a given set of numbers is closed under a given operation.    State the definition of a divides b and a is congruent to b modulo n , and correctly apply these definitions in examples.    Create and translate sets using set builder notation and fluently work with sets written in set builder notation.    Use the symbols related to sets (like , , , , , ) correctly.    Given two sets and a universal set identify the union, intersection, complement, Cartesian product, and set difference and find the power set of a given set.    Identify situations in which it is appropriate to use induction and state the procedure for proving a statement by induction.    Clearly and correctly disprove a statement using a counterexample.    Evaluate if a given proof is valid and adheres to our writing guidelines.    Construct truth tables for statements that use the logical operators and, or, not, and implies, and make conclusions about the truth values of these statements.    Given a conditional statement, identify the hypothesis and conclusion, determine its truth value, and apply it.    Negate a statement with and, or, not, implies, exists, and\/or for all.    Given a statement to be proven using a proof by contrapositive, identify the assumptions to be made and the statements to be proven.    Given a statement to be proven using a proof by contradiction, identify the assumptions to be made and the statements to be proven.    Correctly use function terminology such as domain, codomain, range, image, and preimage.    State the definition of injection, surjection, and bijection, create examples of each, and identify if a given function is an injection, surjection, or bijection.    Prove or disprove that a given relation is reflexive, symmetric, and\/or transitive and identify if the relation is an equivalence relation.    Given an equivalence relation, I can determine the equivalence class of an element. I can list the distinct equivalence classes determined by the relation.       "
},
{
  "id": "targets-3",
  "level": "1",
...
},
{
  "id": "targets-4-3",
  "level": "2",
  "url": "targets-4.html#targets-4-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "odd even "
},
{
  "id": "targets-4-4",
  "level": "2",
  "url": "targets-4.html#targets-4-4",
  "type": "Checkpoint",
  "number": "2.1",
  "title": "",
  "body": "  Prove the product of an odd integer and an even integer is even.    Let be an odd integer and be an even integer. By definition, there exist integers and such that and . Then the product . Let . Since integers are closed under addition and multiplication, is an integer, we've written that , and so is even.   "
},
{
  "id": "targets-4-5",
  "level": "2",
  "url": "targets-4.html#targets-4-5",
  "type": "Remark",
  "number": "2.2",
  "title": "",
...
},
{
  ...
  "body": " Exercise 2.4 (a) and (b)   For each of the following, give three examples of the proposition. Then prove it is true.     If is an even integer then is an even integer.      If is an odd integer, then is an odd integer.    "
},
{
  "id": "WP-02-5",
  "level": "2",
...
},
{
  "id": "WP-03-3",
  "level": "2",
  "url": "WP-03.html#WP-03-3",
  "type": "Checkpoint",
  "number": "3.9",
  "title": "Exercise 2.8 (a).",
  "body": " Exercise 2.8 (a)   Prove that if is an integer, then is an odd integer.   "
},
{
  "id": "WP-03-4",
  "level": "2",
  "url": "WP-03.html#WP-03-4",
  "type": "Checkpoint",
  "number": "3.10",
  "title": "Exercise 2.16.",
...
},
{
  "id": "grading-rubric",
  "level": "2",
  "url": "pp-instructions.html#grading-rubric",
  "type": "Table",
  "number": "4.1",
...
},
{
  ...
  "body": " Portfolio Problem 1 - Play Conjecture Prove     Option 1: Chessboard covering problems  Pick a conjecture from class, or another one you. have been wondering about, about chess- boards and prove it!    Option 2: The game SET  Pick a conjecture about the game SET from class, or something you are curious about, and prove it!    Option 3: Eeeny Meeny Miny Moe  Remember the childhood game for deciding who is it - eeny meeny miny moe? How could you win this game? This could go in a number of different directions. Different number of people? Different rhyme? Do you want to be the last person pointed at or not? What if you do elimination and go until one only one person is left.    Option 4: The pancake problem  The chef in our place is sloppy and when he prepares a stack of pancakes they come out all di!erent sizes. Therefore, when I deliver them to the customer, on the way to the table I rearrange them (so the smallest winds up on top and so on, down to the largest is on the bottom) by grabbing several from the top and flipping them over, repeating this (varying the number I flip) as many times as necessary. If there are n pancakes, what is the maximum number of flips (in terms of n) that I will ever have to use to rearrange them? Note: For this problem, you could do a proof for the maximum number of flips for 3 pancakes.     "
},
{
  "id": "pp-2",
  "level": "1",
...
},
{
  ...
  "body": " Portfolio Problem 3   The Conjectures  For this portfolio problem, you'll prove OR disprove BOTH of the following conjectures. Recall conjecture is a statement that is believed to be true but has not yet been proven. So it could be true or false. Start by trying some concrete example for each conjecture. You should include these examples in your handwritten draft and in your writing revision.    The sum of the cubes of any three consecutive integers is divisible by 3.      The sum of the cubes of any three consecutive integers is divisible by 4.    After doing some examples, if you think the theorem is true, you should write it as a theorem and then write a proof of it. Your proof should start by mathematizing the theorem statement. (By that I mean, how do you turn 3 consecutive integers into something you can work with?)  If you believe a conjecture is false, say so and include one concrete counterexample. Use specific numbers and explain how they make the hypothesis true, but the conclusion is false. (You do not need to correct the theorem, just provide one counterexample!)  A suggesting ordering for your written revision, is   First conjecture statement.    Examples related to the first conjecture.    Either write a theorem statement and a proof, or explain a counterexample.    Second conjecture statement.    Examples related to the second conjecture.    Either write a theorem statement and a proof, or explain a counterexample.      "
},
{
  "id": "pp-3-2-3",
  "level": "2",
...
},
{
  ...
  "number": "1.15",
  "title": "",
  "body": "  Statements of the form If... then... are called conditional statements . We will explore conditional statements a lot in MTH 210. Based on and , answer the following. What must we do to establish that a conditional statement is true? What is the only way that a conditional statement can be false?   "
},
{
...
},
{
  ...
  "number": "1.17",
  "title": "",
  "body": "   Let's begin with some true\/false questions. Explain your answers.     True\/False: If objects are placed in boxes, then every box has at least 2 items.      True\/False: If objects are placed in boxes, then no box is empty.      True\/False: Given objects placed in boxes, at least one box has objects in it.     "
},
{
...
},
{
  ...
  "number": "1.20",
  "title": "",
  "body": "  (The Fundamental Theorem of SET) Given any two cards from the deck in SET, those two cards determine a .   "
},
{
...
},
{
  ...
  "number": "2.6",
  "title": "",
  "body": " A set of things some people may or may not consider sandwiches.   A list of potential sandwiches with their pictures.   "
},
{
...
},
{
  ...
  "number": "2.10",
  "title": "",
  "body": "  Let's use what we did in , but add the definitions, so we can do infinitely many examples at once! This will constitute a proof of as we will know for every possible example.    "
},
{
...
},
{
  ...
  "number": "2",
  "title": "",
  "body": "  j,k s.t. x=2k+1 and y=2j+1.  xy=(2k+1)(2j+1)=2(2kj+j+k)+1 which is even.  "
},
{
...
},
{
  ...
  "number": "2.18",
  "title": "",
  "body": "  Answer the following 4 questions about each pair. On the next page there are some example triangles to guide your discussion.   Is there any integer that is in both sets?    Does the left set contain all of the members of the right? Does the right set contain all the members on the left?    Can you say anything about the relationship between the sets?    If you use an oval region to represent one set, how would you portray the other set in that pair?                                                      "
},
{
...
},
{
  ...
  "number": "2.22",
  "title": "",
  "body": "  In problems where we are concerned with the issue of divides, the Division Algorithm provides a natural way to consider cases. Consider    "
},
{
...
},
{
  ...
  "number": "3.1",
  "title": "",
  "body": "  A set is an unordered collection of distinct objects which are called elements .     If is an element of a set , we write . This is read  in  .    If is not an element of a set , we write . This is read  is not in  .    If every element of is also an element of then is a subset of , denoted and read  is a subset of  .    If and , then we write and we say  is a proper subset of  .    If is not a subset of then we write and say  is not a subset of  . This means there exists an such that .    If and have the exact same elements, we write . This is read as  equals  .      "
},
{
  "id": "ch-3-sets-2-4",
  "level": "2",
  ...
  "body": " Set Relationships   Given the following information, what are all the possible set diagrams for the two sets? Can you find any other set relationships that must be true? (Think specifically about the complement sets as well.)                    and              Every element of is not an element of .    "
},
{
  "id": "ch-3-sets-2-5",
  "level": "2",
...
},
{
  ...
  "number": "3.4",
  "title": "",
  "body": "    Roster notation is when we list all the elements, or list enough elements so that pattern is obvious and use (dots). E.g., .    Set builder notation is when we define the elements by a rule. E.g., . or .     "
},
{
  "id": "ch-3-sets-3-3",
  "level": "2",
...
},
{
  ...
  "body": " Play, Conjecture, Prove Option   In a simplified version of the super bowl, teams can score points (for a field goal) or points (for a touchdown). What are the possible scores for one team?   "
},
{
...
},
{
  ...
  "number": "5.5",
  "title": "",
  "body": "  Consider your answers in . Imagine forming the set of all the things (numbers\/ shapes) that make the first part of each sentence true. Also imagine forming the set of all things that make the second part of each sentence true.     For the true statements, what is the relationship between the two sets? How would you express this in set notation? How would you represent this in a diagram?      For the false statements, what is the relationship between the two sets? How would you express this in set notation? How would you represent this in a diagram?      For each true statement, can you write another “For all… if… then…” statement that must also be true because this statement is true?    "
},
{
  "id": "ch-logic-3-5",
  "level": "2",
...
},
{
  ...
  "number": "5.10",
  "title": "",
  "body": "  For the first two parts, write a statement with the opposite truth value.     For all integers , is a multiple of 2.      There exists an integer such that is a multiple of 2.      What do the above say about the negations of for all and there exists ?    "
},
{
  "id": "ch-logic-6-4-1",
  "level": "2",
...
},
{
  ...
  "number": "5.12",
  "title": "",
  "body": " The statement can be said as   For each real number , .    The square of every real number is at least >.    The square of a real number is at least .    If is a real number, then .     The last statement, is a conditional statement, that hides the universal quantifier.  "
},
{
  "id": "ch-logic-7-2-3",
  "level": "2",
...
},
{
  ...
  "number": "6.4",
  "title": "",
  "body": "  For each of the following statements, find the contrapositive (turning the statement into an if-then conditional statement if needed). Then decide which one seems easier to prove - the statement or its contrapositive, and briefly explain why.     For all natural numbers , if then .   Contrapositive:    Circle one and briefly explain:    Easier to prove the original  Easier to prove the contrapositive       For all integers and , if is even, then is even or is even.   Contrapositive:    Circle one and briefly explain:    Easier to prove the original  Easier to prove the contrapositive       Let , and let be a prime. If then and .   Contrapositive:    Circle one and briefly explain:    Easier to prove the original  Easier to prove the contrapositive       For all integers , if is even if and only if is even. (Note there are 2 conditional statements here, write out both conditional statements and their contrapositives.)   Contrapositive:    Circle one and briefly explain:    Easier to prove the original  Easier to prove the contrapositive    Contrapositive:    Circle one and briefly explain:    Easier to prove the original  Easier to prove the contrapositive     "
},
{
...
},
{
  ...
  "number": "8.19",
  "title": "",
  "body": "  Do a proof sketch that the composition of two surjections is a surjection. (Start by writing down what you are assuming at the top and what you are proving at the bottom, then write definitions of each.)   "
},
{
...
},
{
  ...
  "body": " Finding equivalence classes    Let and define by  For , if and only if and have the same number of digits.  This is an equivalence relation (briefly think about why). Determine all the distinct equivalence classes determined by .      Recall that is the set of all matrices and that if then the determinant of is given by . Define by,  For all , if and only if .     Find two matrices and such that .      Is an equivalence relation? (Briefly think about it, don't need to prove.)      Let . Find two elements of . Challenge Question: Can you find the entire equivalence class?      "
},
{
